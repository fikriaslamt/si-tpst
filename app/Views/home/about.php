<div id="about" class="w-2xl lg:w-7/12 lg:mx-auto  mx-10 mt-20 mb-10">
       ...
       <div class="2xl:container 2xl:mx-auto ">
            <p class="font-normal text-sm leading-3 text-indigo-700  hover:text-indigo-800 cursor-pointer pb-2">Tentang Kami</p>
              ...
              <div class="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12 mt-20 mb-20 h-60">
                     <div class="w-full  content-center mb-5">
                            <h2 class="w-full font-bold lg:text-4xl text-center text-3xl lg:leading-10 leading-9 mb-5">LOKASI</h2>
                            <iframe class="w-full h-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.365698975196!2d105.240722!3d-5.3610498!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40c55d53a2b51b%3A0x8e16bb567b9bee92!2sTPST%20Unila!5e0!3m2!1sid!2sid!4v1693128966265!5m2!1sid!2sid"  style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                     </div>
              </div>
