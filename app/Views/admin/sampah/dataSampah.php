                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <ul class="flex flex-row items-center justify-center">  
                              <li class="mx-1">
                                <?php if($data["status"]=="Belum Terkelola"): ?>
                                  <span>
                                    <button data-modal-target="delete-modal"
                                        data-modal-toggle="delete-modal"
                                        data-id="<?=$data["id"]?>"
                                        class="bg-green-500 btn-sm rounded-50"
                                        type="button"
                                        data-toggle="tooltip"
                                        data-placement="top"
                                        title="Update Status">
                            ...
                            <?php if($data["status"]=="Belum Terkelola"): ?>
                              <li class="mx-1">
                                <button data-modal-target="edit-modal"
                                        ...
                                        data-total_berat="<?= $data["total_berat"] ?>"
                ...
                <form class="space-y-6" method="POST">
                    ...
                    <!-- <div>
                        ...
                        <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">                                      
                          <option >Terkelola</option>                   
                          <option >Belum Terkelola</option>                   
                        </select> 
                    </div> -->
...
<script>
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function () {
            const dataId = this.getAttribute('data-id');
            const deleteUrl = `<?= base_url('DataSampah/setStatusTerkelola/') ?>${dataId}`;
