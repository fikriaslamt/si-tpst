      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-header lg:flex lg:flex-row w-full ">
              ...
              <form class="lg:flex md:flex mb-2 mt-2 lg:m-0 " action="<?= base_url('Admin/daftarProduk'); ?>" method="POST">
              ...
              <div class="card-body overflow-auto">
                ...
                <table id="example1" class="table table-striped mt-5 text-center">
                  <thead>
                  <tr>
                    <th>No</th>
              ...
              <h3 class="mb-5 text-lg font-normal text-blue-900 ">Edit Data</h3>
                <form class="space-y-6"  method="POST" enctype="multipart/form-data">
                      ...
                      <div>
                          ...
                          <input type="number" min=0 name="harga" id="harga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required>
                      </div>

                      <div>
                          <label class="block mb-2 text-sm font-medium text-blue-900" for="image">Upload Gambar Produk</label>
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="<?= base_url('DaftarProduk/tambahDaftarProduk')?>" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    const editJenis = editForm.querySelector('[name="jenis"]');
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            const editUrl = `<?= base_url('DaftarProduk/editDaftarProduk/') ?>${dataId}`;

            editForm.action = editUrl;
            editJenis.value = dataJenis;
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function () {
            const dataId = this.getAttribute('data-id');
            const deleteUrl = `<?= base_url('DaftarProduk/deleteDaftarProduk/') ?>${dataId}`;
