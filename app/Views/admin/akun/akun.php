...
<script>
    ...
    const editUsernameInput = editForm.querySelector('[name="username"]');
    const editPasswordInput = editForm.querySelector('[name="password"]');
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            const dataUsername = this.getAttribute('data-username');
            const dataPassword = this.getAttribute('data-password');
            const editUrl = `<?= base_url('Akun/editAkun/') ?>${dataId}`;

            editForm.action = editUrl;
            editNamaInput.value = dataNama;
            editUsernameInput.value = dataUsername;
            editPasswordInput.value = dataPassword;
        });
    });
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function () {
            const dataId = this.getAttribute('data-id');
            const deleteUrl = `<?= base_url('Akun/deleteAkun/') ?>${dataId}`;
